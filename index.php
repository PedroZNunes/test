...
<section id="content">
  ...
  <div class="content-wrap">
    ...
    if ( !is_single() && is_home() &&
      function_exists( 'wpp_get_mostpopular' ) && get_theme_mod( 'pu_show_popular_posts' ) ){
        ...
        'wpp_start'       =>  '<div class="section header-stick bottommargin-lg clearfix" style="padding: 20px 0;">
                                <div>
                                  <div class="container clearfix">
                                    <span class="badge badge-danger bnews-title">' . get_theme_mod( 'pu_popular_posts_text' ) . '</span>
